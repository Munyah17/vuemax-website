...
$pageDesc  = 'Vuemax Investments is a leading supplier of quality fencing, steel and hardware products in Zimbabwe. Learn about our story, mission and values.';
$active    = 'about';
...
<section class="page-hero">
  <div class="container">
    ...
    <h1>About <span class="accent">Vuemax Investments</span></h1>
  ...
  <div class="container">
    <div class="story-grid">
      ...
      <div class="story-content reveal reveal-d1">
        ...
        <h2>Zimbabwe's Trusted Supplier of Fencing, Steel &amp; Hardware</h2>
        <p>Vuemax Investments began with a simple belief: that Zimbabwean homes, farms and businesses deserve access to high-quality fencing, steel and hardware products — backed by genuine expertise and honest service.</p>
        <p>Over the years, we've grown into a trusted supplier serving customers across all ten provinces, from individual homeowners to large commercial and agricultural operations. Every project we deliver strengthens our reputation as a partner who shows up, delivers on time, and stands behind the work.</p>
        <p>Today, we continue to expand our catalogue and capabilities — investing in smarter tools, faster delivery and a service experience that makes buying fencing and building materials simple.</p>
