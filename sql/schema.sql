...
-- Diamond mesh wide-aperture variants — ids 28, 29, 30, 31, 32, 33
INSERT INTO `products`
(`subcategory_id`, `slug`, `name`, `short_desc`, `long_desc`, `unit`,
 `price_usd`, `roll_metres`, `post_price`, `top_wire_rate`, `gate_price`, `install_rate`,
 `image`, `badge`, `rating`, `reviews_count`, `is_featured`, `sort_order`) VALUES
(1, 'diamond-mesh-70x70-2-5mm', 'Diamond Mesh 70x70 (2.5mm)',
 ...
 'Diamond mesh fencing with a wider 70x70mm aperture, 2.5mm wire gauge, hot-dip galvanised. Each roll is 30m long, available in heights from 1.0m to 3.0m. A lighter, economical option for boundary and farm fencing. Also stocked in 2mm and 3.15mm gauges.',
 'roll', 55.00, 30, 8.00, 0.80, 180.00, 3.50,
 'assets/img/products/diamond-mesh.jpg',
 NULL, 4.7, 0, 0, 28),
(1, 'diamond-mesh-70x70-3-15mm', 'Diamond Mesh 70x70 (3.15mm)',
 ...
 'Diamond mesh fencing with a wider 70x70mm aperture and heavy 3.15mm wire gauge, hot-dip galvanised. Each roll is 30m long, available in heights from 1.0m to 3.0m. Also stocked in 2mm and 2.5mm gauges.',
 'roll', 124.00, 30, 8.00, 0.80, 180.00, 3.50,
 'assets/img/products/diamond-mesh.jpg',
 NULL, 4.7, 0, 0, 29),
(1, 'diamond-mesh-80x80-2-5mm', 'Diamond Mesh 80x80 (2.5mm)',
 ...
 'Diamond mesh fencing with a wide 80x80mm aperture, 2.5mm wire gauge, hot-dip galvanised. Each roll is 30m long, available in heights from 1.0m to 3.0m. The most economical diamond mesh option — ideal for large boundary and farm fences. Also stocked in 2mm and 3.15mm gauges.',
 'roll', 55.00, 30, 8.00, 0.80, 180.00, 3.50,
 'assets/img/products/diamond-mesh.jpg',
 NULL, 4.7, 0, 0, 30),
(1, 'diamond-mesh-80x80-3-15mm', 'Diamond Mesh 80x80 (3.15mm)',
 ...
 'Diamond mesh fencing with a wide 80x80mm aperture and heavy 3.15mm wire gauge, hot-dip galvanised. Each roll is 30m long, available in heights from 1.0m to 3.0m. Also stocked in 2mm and 2.5mm gauges.',
 'roll', 100.00, 30, 8.00, 0.80, 180.00, 3.50,
 'assets/img/products/diamond-mesh.jpg',
 NULL, 4.7, 0, 0, 31),
(1, 'diamond-mesh-70x70-2mm', 'Diamond Mesh 70x70 (2mm)',
 'Wider-aperture diamond mesh. 70x70mm aperture, 2mm wire, 30m rolls, heights 1.0m to 3.0m.',
 'Diamond mesh fencing with a wider 70x70mm aperture, 2mm wire gauge, hot-dip galvanised. Each roll is 30m long, available in heights from 1.0m to 3.0m. A lighter, economical option for boundary and farm fencing. Also stocked in 2.5mm and 3.15mm gauges.',
 'roll', 60.00, 30, 8.00, 0.80, 180.00, 3.50,
 'assets/img/products/diamond-mesh.jpg',
 NULL, 4.7, 0, 0, 32),
(1, 'diamond-mesh-80x80-2mm', 'Diamond Mesh 80x80 (2mm)',
 'Economy wide-aperture mesh. 80x80mm aperture, 2mm wire, 30m rolls, heights 1.0m to 3.0m.',
 'Diamond mesh fencing with a wide 80x80mm aperture, 2mm wire gauge, hot-dip galvanised. Each roll is 30m long, available in heights from 1.0m to 3.0m. The most economical diamond mesh option — ideal for large boundary and farm fences. Also stocked in 2.5mm and 3.15mm gauges.',
 'roll', 40.00, 30, 8.00, 0.80, 180.00, 3.50,
 'assets/img/products/diamond-mesh.jpg',
 NULL, 4.7, 0, 0, 33);
...
(28, 'Height 1.0 m',      '$55',                           10),
(28, 'Height 1.2 m',      '$72',                           11),
(28, 'Height 1.5 m',      '$90',                           12),
(28, 'Height 1.8 m',      '$105',                          13),
(28, 'Height 2.0 m',      '$110',                          14),
(28, 'Height 2.1 m',      '$120',                          15),
(28, 'Height 2.4 m',      '$135',                          16),
(28, 'Height 2.5 m',      '$140',                          17),
(28, 'Height 3.0 m',      '$190',                          18),
...
(29, 'Height 1.0 m',      '$124',                          10),
(29, 'Height 1.2 m',      '$140',                          11),
(29, 'Height 1.5 m',      '$180',                          12),
(29, 'Height 1.8 m',      '$220',                          13),
(29, 'Height 2.0 m',      '$250',                          14),
(29, 'Height 2.1 m',      '$270',                          15),
(29, 'Height 2.4 m',      '$300',                          16),
(29, 'Height 2.5 m',      '$320',                          17),
(29, 'Height 3.0 m',      '$400',                          18),
...
(30, 'Height 1.0 m',      '$55',                           10),
(30, 'Height 1.2 m',      '$65',                           11),
(30, 'Height 1.5 m',      '$80',                           12),
(30, 'Height 1.8 m',      '$93',                           13),
(30, 'Height 2.0 m',      '$100',                          14),
(30, 'Height 2.1 m',      '$105',                          15),
(30, 'Height 2.4 m',      '$130',                          16),
(30, 'Height 2.5 m',      '$130',                          17),
(30, 'Height 3.0 m',      '$170',                          18),
...
(31, 'Height 1.0 m',      '$100',                          10),
(31, 'Height 1.2 m',      '$140',                          11),
(31, 'Height 1.5 m',      '$160',                          12),
(31, 'Height 1.8 m',      '$180',                          13),
(31, 'Height 2.0 m',      '$210',                          14),
(31, 'Height 2.1 m',      '$240',                          15),
(31, 'Height 2.4 m',      '$260',                          16),
(31, 'Height 2.5 m',      '$270',                          17),
(31, 'Height 3.0 m',      '$350',                          18),
(31, 'Finish',            'Hot-dip galvanised',            20),

-- Diamond mesh 70x70 2mm (product_id = 32)
(32, 'Material',          'Hot-dip galvanised steel wire', 1),
(32, 'Mesh Aperture',     '70 mm × 70 mm',                 2),
(32, 'Wire Gauge',        '2.0 mm',                        3),
(32, 'Roll Length',       '30 m',                          4),
(32, 'Height 1.0 m',      '$60',                           10),
(32, 'Height 1.2 m',      '$65',                           11),
(32, 'Height 1.5 m',      '$70',                           12),
(32, 'Height 1.8 m',      '$80',                           13),
(32, 'Height 2.0 m',      '$90',                           14),
(32, 'Height 2.1 m',      '$95',                           15),
(32, 'Height 2.4 m',      '$110',                          16),
(32, 'Height 2.5 m',      '$115',                          17),
(32, 'Height 3.0 m',      '$135',                          18),
(32, 'Finish',            'Hot-dip galvanised',            20),

-- Diamond mesh 80x80 2mm (product_id = 33)
(33, 'Material',          'Hot-dip galvanised steel wire', 1),
(33, 'Mesh Aperture',     '80 mm × 80 mm',                 2),
(33, 'Wire Gauge',        '2.0 mm',                        3),
(33, 'Roll Length',       '30 m',                          4),
(33, 'Height 1.0 m',      '$40',                           10),
(33, 'Height 1.2 m',      '$45',                           11),
(33, 'Height 1.5 m',      '$56',                           12),
(33, 'Height 1.8 m',      '$70',                           13),
(33, 'Height 2.0 m',      '$83',                           14),
(33, 'Height 2.1 m',      '$88',                           15),
(33, 'Height 2.4 m',      '$95',                           16),
(33, 'Height 2.5 m',      '$100',                          17),
(33, 'Height 3.0 m',      '$145',                          18),
(33, 'Finish',            'Hot-dip galvanised',            20);
