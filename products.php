    ...
    <main>
      ...
      <div class="product-grid" id="productGrid">
        ...
        <a class="product-card" href="product-detail.php?slug=diamond-mesh">
          <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=600&q=80')">
        ...
        <a class="product-card" href="product-detail.php?slug=chicken-mesh">
          <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=600&q=80')"></div>
          <div class="body">
            <span class="cat">Fencing</span>
            <h3>Chicken Mesh</h3>
        ...
        <a class="product-card" href="product-detail.php?slug=field-fence">
          <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1500595046743-cd271d694d30?auto=format&fit=crop&w=600&q=80')"></div>
          <div class="body">
            <span class="cat">Fencing</span>
            <h3>Field Fence</h3>
