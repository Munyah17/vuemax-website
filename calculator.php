      ...
      <div class="form-panel" id="panel-2" style="display:none;">
        ...
        <div class="type-cards" id="typeCards">
          <label class="type-card selected">
            ...
            <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&w=400&q=80')"></div>
            <strong>Diamond Mesh</strong>
            <span>Popular · durable</span>
          </label>
          <label class="type-card">
            <input type="radio" name="fenceType" value="game-fence">
            <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1518709268805-4e9042af9f23?auto=format&fit=crop&w=400&q=80')"></div>
            <strong>Game Fence</strong>
            <span>Heavy-duty wildlife</span>
          </label>
          <label class="type-card">
            <input type="radio" name="fenceType" value="barbed-wire">
            <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1533154683836-84ea7a0bc310?auto=format&fit=crop&w=400&q=80')"></div>
            <strong>Barbed Wire</strong>
            <span>High security</span>
          </label>
          <label class="type-card">
            <input type="radio" name="fenceType" value="chicken-mesh">
            <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1548550023-2bdb3c5beed7?auto=format&fit=crop&w=400&q=80')"></div>
            <strong>Chicken Mesh</strong>
            <span>Poultry & small animals</span>
          </label>
          <label class="type-card">
            <input type="radio" name="fenceType" value="field-fence">
            <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1500595046743-cd271d694d30?auto=format&fit=crop&w=400&q=80')"></div>
            <strong>Field Fence</strong>
            <span>Agricultural</span>
          </label>
          <label class="type-card">
            <input type="radio" name="fenceType" value="razor-wire">
            <div class="thumb" style="background-image:url('https://images.unsplash.com/photo-1595278069441-2cf29f8005a4?auto=format&fit=crop&w=400&q=80')"></div>
