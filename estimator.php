...
const CATALOG = {
  'diamond-mesh': {
    ...
    rollPrice: 120, rollMetres: 30, postPrice: 8, topWirePerM: 0.8, gatePrice: 180, installPerM: 3.5,
  ...
  'barbed-wire': {
    ...
    rollPrice: 45, rollMetres: 100, postPrice: 8, topWirePerM: 0.6, gatePrice: 160, installPerM: 2.5,
...
function generateEstimate(){
  ...
  // Phase 2: replace with a real fetch to api/estimate.php
  setTimeout(() => {
...
function computeEstimate(text){
  ...
  const posts = Math.ceil(perimeter / 2.5) + 4;
  const postCost = posts * product.postPrice;
  items.push({
    name: 'Steel Posts',
    qty: posts + ' pcs',
    cost: postCost
...
<!-- ===================== HERO ===================== -->
<section class="page-hero est-hero">
  <div class="container">
