  ...
  <div class="container">
    <div class="contact-cards-grid">
      ...
      <a href="https://wa.me/263784689857" target="_blank" rel="noopener" class="contact-card whatsapp">
        <div class="ico">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M20.52 3.48A11.94 11.94 0 0 0 12.04 0C5.5 0 .2 5.3.2 11.84c0 2.09.55 4.13 1.6 5.93L0 24l6.4-1.68a11.83 11.83 0 0 0 5.64 1.44h.01c6.53 0 11.84-5.3 11.84-11.84 0-3.16-1.23-6.13-3.37-8.44z"/></svg>
        </div>
        <h3>WhatsApp</h3>
